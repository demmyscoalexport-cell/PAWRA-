/**
 * Official-style social platform logos (Simple Icons paths).
 */
...
const LOGOS: Record<SocialPlatform, (props: SVGProps<SVGSVGElement>) => JSX.Element> = {
  instagram: (props) => (
...
/** Brand accent colors for hover states. */
