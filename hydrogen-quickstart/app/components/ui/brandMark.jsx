 ...
 * Geometric, calm, premium. viewBox 0 0 48 48.
 */

/** Deep teal / inkwell — used when not inheriting currentColor */
export const BRAND_TEAL = '#0D9488';
export const BRAND_INK = '#1E293B';
export const BRAND_STONE = '#F8F6F4';
export const BRAND_WHITE = '#FFFFFF';

/**
 * Icon mark paths (paw pad + toes + leaf accent).
 * Designed to read at 16px–512px.
 */
export function BrandMarkPaths({leafClassName = '', padClassName = ''}) {
  return (
    <g fill="none" fillRule="evenodd">
      {/* Primary pad — soft rounded shield / heart-leaf base */}
      <path
      ...
      {/* Leaf accent — nature / care overlay cut in lighter contrast via opacity */}
      <path
...
/**
 * Geometric wordmark letter paths for "PAWRA" (viewBox 0 0 200 40).
 * Soft Gotham / Circular inspired uppercase.
 */
