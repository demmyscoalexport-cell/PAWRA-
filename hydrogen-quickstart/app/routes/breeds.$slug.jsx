      ...
      <div className="mx-auto max-w-1440">
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <h1 className="mt-2 font-serif text-display-s text-text-primary">{breed.name}</h1>
            ...
            <h2 className="mt-10 font-serif text-heading-s text-text-primary">Care tips</h2>
        ...
        <section className="mt-16">
          <h2 className="font-serif text-heading-m text-text-primary">Shop for {breed.name}s</h2>
