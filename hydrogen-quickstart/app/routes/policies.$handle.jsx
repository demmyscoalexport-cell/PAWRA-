  ...
  return (
    <div className="bg-page-bg px-4 py-12 md:px-8 md:py-20">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="mt-6 font-sans text-display-s text-text-primary">{policy.title}</h1>
        <div
          className="prose-pawra mt-10 font-sans text-body-m text-text-primary [&_a]:text-action-primary [&_a]:underline [&_h2]:mt-8 [&_h2]:font-sans [&_h2]:text-heading-s [&_p]:mt-4"
