...
export type GorgiasCustomerQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type GorgiasCustomerQuery = {
  customer: Pick<
    CustomerAccountAPI.Customer,
    'id' | 'firstName' | 'lastName'
  > & {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query GorgiasCustomer($language: LanguageCode) @inContext(language: $language) {\n    customer {\n      id\n      firstName\n      lastName\n      emailAddress {\n        emailAddress\n      }\n    }\n  }\n': {
    return: GorgiasCustomerQuery;
    variables: GorgiasCustomerQueryVariables;
  };
}
